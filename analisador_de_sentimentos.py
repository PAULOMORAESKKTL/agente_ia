...
def analisador_de_sentimentos(restaurante):
    ...
    print(f'Iniciou a analise do {restaurante}')
    try:
        ...
        print(f'Finalizou a analise do {restaurante}')
    except anthropic.APIConnectionError as e:
        print("Não foi possível conectar ao servidor",e.__cause__)
    except anthropic.RateLimitError as e:
        print("Um código de status 429 foi recebido; Limite de acesso foi atingido.")
